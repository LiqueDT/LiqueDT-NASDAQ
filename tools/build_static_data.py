...
def load_market_yfinance() -> dict:
    ...
    for series in server.MARKET_SERIES:
        try:
            ...
            if series["id"] == "NDX":
                ...
                corr_20 = server.rolling_corr(primary_history, daily_close, 20)
                corr_60 = server.rolling_corr(primary_history, daily_close, 60)
            ...
            items.append({
                ...
                "nasdaq_score": round(nasdaq_score, 3),
                "currency": "USD",
    ...
    summary = "Correlation-aware Nasdaq market movement: " + ", ".join(
